...
<body>
                        ...
                        <div class="hero-cap text-center">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    ...
                                    <li class="breadcrumb-item"><a href="#"> Viewed Trip Packages</a></li> 
                                </ol>
                            </nav>
                            <h2 data-animation="fadeInLeft" data-delay=".4s"> Viewed Packages </h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
            <h3 class="text-center text-success"> Viewed all Packages  </h3>
    
    <hr>
            <div class="row row-margin-bottom">

<?php 
$selp=mysqli_query($con,"SELECT * FROM trippackage tp,triptype tt,tripinfo ti WHERE tt.tid=tp.tid AND ti.pid=tp.pid ORDER BY infoid DESC");
